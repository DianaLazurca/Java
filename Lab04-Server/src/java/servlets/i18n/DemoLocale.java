...
public class DemoLocale extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DemoLocale</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DemoLocale at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("bundle", "messages_" + language);
        request.setAttribute("locale", request.getParameter("language"));
        NumberFormat numberFormatNumber = NumberFormat.getNumberInstance(locale); 
        request.setAttribute("fnumber", numberFormatNumber.format(123578));
        
        NumberFormat numberFormatCurrency = NumberFormat.getCurrencyInstance(locale);
        request.setAttribute("fcurrency", numberFormatCurrency.format(123578));
